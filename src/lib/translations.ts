...
export const translations = {
  pt: {
    ...
    socialProof: {
      ...
      title:
        "Construímos o mercado do chá junto de nossos alunos.",
      testimonials: [
        {
    ...
    cookies: {
      ...
      message:
        "Utilizamos cookies para melhorar sua experiência, analisar o tráfego e personalizar conteúdos. Você pode aceitar todos, recusar ou personalizar suas preferências. Saiba mais em nossa",
      privacyLink: "Política de Privacidade",
      accept: "Aceitar todos",
      reject: "Recusar",
      customize: "Personalizar",
      save: "Salvar preferências",
      categoriesTitle: "Categorias de cookies",
      necessary: "Necessários",
      necessaryDesc: "Essenciais para o funcionamento do site. Sempre ativos.",
      analytics: "Análise e estatísticas",
      analyticsDesc: "Ajudam a entender como o site é utilizado para melhorá-lo.",
      marketing: "Marketing",
      marketingDesc: "Permitem campanhas e mensagens mais relevantes para você.",
    },
  },
  en: {
    nav: {
    ...
    cookies: {
      title: "Your privacy",
      message:
        "We use cookies to improve your experience, analyze traffic and personalize content. You can accept all, reject or customize your preferences. Learn more in our",
      ...
      necessary: "Necessary",
      necessaryDesc: "Essential for the site to function. Always active.",
      analytics: "Analytics",
      analyticsDesc: "Help us understand how the site is used to improve it.",
      marketing: "Marketing",
      marketingDesc: "Enable more relevant campaigns and messages for you.",
    },
  },
  es: {
    nav: {
    ...
    cookies: {
      title: "Tu privacidad",
      message:
        "Utilizamos cookies para mejorar tu experiencia, analizar el tráfico y personalizar contenidos. Puedes aceptar todos, rechazar o personalizar tus preferencias. Más información en nuestra",
      ...
      necessaryDesc: "Esenciales para el funcionamiento del sitio. Siempre activos.",
      analytics: "Análisis y estadísticas",
      analyticsDesc: "Ayudan a entender cómo se usa el sitio para mejorarlo.",
      marketing: "Marketing",
      marketingDesc: "Permiten campañas y mensajes más relevantes para ti.",
    },
  },
} as const;
